...
public class GroceryWindow extends AppCompatActivity {
...
//        Toast.makeText(this, "made it", Toast.LENGTH_SHORT).show();
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(aSingleMessage)) {
                    editText.setError("Empty entry ignored");
                } else {
                    /*
                    ...
                    editText.setText("");
                    editText.setHint("So far " + getMsgs().size() + " items");
    ...
    private class ChatAdapter extends ArrayAdapter<String> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            LayoutInflater inflater = GroceryWindow.this.getLayoutInflater();
            View result = null;
