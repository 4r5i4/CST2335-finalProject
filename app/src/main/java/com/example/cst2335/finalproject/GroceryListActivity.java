...
import com.example.cst2335.finalproject.dummy.DummyContent;
...
//        setupRecyclerView((RecyclerView) recyclerView);
        ...
        final GroceryListActivity.ChatAdapter messageAdapter = new GroceryListActivity.ChatAdapter(this);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(aSingleMessage)) {
                    editText.setError("Empty item ignored");
                } else {
                    /*
  ...
  */
    private class ChatAdapter extends ArrayAdapter<String> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            LayoutInflater inflater = GroceryListActivity.this.getLayoutInflater();
            View result = null;
            ...
            TextView message = (TextView) result.findViewById(R.id.listtextview);  //this is the msg from the chat_row_incoming/outing
            ...
            result.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(GroceryDetailFragment.ARG_ITEM_ID, messageText);
                        ...
                        intent.putExtra(GroceryDetailFragment.ARG_ITEM_ID, messageText);
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        Bundle arguments = new Bundle();
                        arguments.putString(GroceryDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        GroceryDetailFragment fragment = new GroceryDetailFragment();
                        fragment.setArguments(arguments);
                        getSupportFragmentManager().beginTransaction()
                                .replace(R.id.message_detail_container, fragment)
                        ...
                        Context context = v.getContext();
                        Intent intent = new Intent(context, GroceryDetailActivity.class);
                        intent.putExtra(GroceryDetailFragment.ARG_ITEM_ID, holder.mItem.id);
